...
describe OFX::Parser do
  ...
  it 'should raise exception when trying to parse an invalid OFX file' do
    lambda {
      OFX::Parser::Base.new('spec/fixtures/invalid_headers_v211.ofx')
    }.should raise_error(OFX::InvalidFileHeader)
  end
